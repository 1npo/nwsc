...
API_URL_USCB_GEOCODE = 'http://geocoding.geo.census.gov/geocoder/locations/onelineaddress?benchmark=Public_AR_Current&format=json&address='
API_URL_NWS_POINTS = 'http://api.weather.gov/points/'
API_URL_NWS_GRIDPOINTS = 'http://api.weather.gov/gridpoints/'
API_URL_NWS_STATIONS = 'http://api.weather.gov/stations/'
